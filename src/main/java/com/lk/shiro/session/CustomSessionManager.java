package com.lk.shiro.session;

import com.lk.bean.UserDO;
import com.lk.bean.UserOnlineBo;
...
public class CustomSessionManager {
    ...
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(CustomShiroSessionDAO.class);
    /**
     * session status
     */
    ...
    public List<SimplePrincipalCollection> getSimplePrincipalCollectionByUserId(Integer...userIds){
        ...
        for (Session session : sessions) {
            ...
            if(null != obj && obj instanceof SimplePrincipalCollection){
                ...
                if(null != obj && obj instanceof UserDO){
    ...
    private UserOnlineBo getSessionBo(Session session){
        ...
        if(obj instanceof SimplePrincipalCollection){
            ...
            if(null != obj && obj instanceof UserDO){
                //存储session + user 综合信息
                UserOnlineBo userBo = new UserOnlineBo((UserDO)obj);
                //最后一次和系统交互的时间
